...
abstract class AbstractIblockPropertyValuesTable extends DataManager
{
    ...
    public static function getMap(): array
    {
        ...
        if ($cache->initCache(0, md5($cacheDir), $cacheDir)) {
            ...
            foreach (static::getProperties() as $property) {
                ...
                if ($property['CODE'] === 'COLOR_ID') {
                    $map['COLOR_ID'] = new StringField("PROPERTY_{$property['ID']}");
                    $map['COLOR_ELEMENT'] = new ReferenceField(
                        'COLOR_ELEMENT',
                        ElementTable::class,
    ...
    public static function getElementNameById($elementId): ?string
    {
